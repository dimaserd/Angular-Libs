...
export class DataBlockConverter {
  ...
  public ConvertBlock(): UserInterfaceBlock {
    if (
      this._block.interfaceType === UserInterfaceType.GenericInterfaceForArray ||
      this._block.interfaceType === UserInterfaceType.GenericInterfaceForClass
    ) {
    ...
    if (
      this._block.interfaceType === UserInterfaceType.MultipleDropDownList ||
      this._block.interfaceType === UserInterfaceType.DropDownList
    ) {
