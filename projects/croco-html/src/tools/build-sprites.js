...
const svgDirectoryPath = 'projects/croco-html/src/assets/svg-for-sprites/';
const iconIds = [];
const config = {
  dest: 'projects/croco-html/src/assets/sprites',
  shape: {
    id: {
      generator: (filePath) => {
...
fs.readdir(svgDirectoryPath, (err, files) => {
  ...
  spriter.compile(function (error, result) {
    ...
    fs.writeFileSync(
      path.resolve('projects/croco-html/src/sprites-hash.ts'),
    ...
    fs.writeFileSync(
      path.resolve('projects/croco-html/src/sprites-ids.type.ts'),
